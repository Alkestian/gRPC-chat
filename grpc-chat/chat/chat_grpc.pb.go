...
type ChatServiceClient interface {
	JoinChat(ctx context.Context, in *JoinChatRequest, opts ...grpc.CallOption) (ChatService_JoinChatClient, error)
}
...
func (c *chatServiceClient) JoinChat(ctx context.Context, in *JoinChatRequest, opts ...grpc.CallOption) (ChatService_JoinChatClient, error) {
...
type ChatServiceServer interface {
	JoinChat(*JoinChatRequest, ChatService_JoinChatServer) error
...
func (UnimplementedChatServiceServer) JoinChat(*JoinChatRequest, ChatService_JoinChatServer) error {
